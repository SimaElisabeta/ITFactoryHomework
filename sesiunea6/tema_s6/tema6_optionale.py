...
class Factura:
    ...
    def genereaza_factura(self):
        return f'Factura seria: {self.seria}, număr: {self.numar} \n' \
               ...
               f'{self.nume_produs:<15}| {self.cantitate:<15}| {self.pret_buc:<15}| {self.pret_buc * self.cantitate}'
...
class Masina:
    ...
    def vopseste(self, culoare):
        if culoare in self.culori_disponibile:
            ...
            raise ColorNotInRangeException(f'Nu avem aceasta culoare in paletar, culorile disponibile sunt: {self.culori_disponibile}')
...
print(f'Descriere masina in fabrica -> {masina1.descrie()}')
...
print()
print(f'Descriere masina personalizata -> {masina1.descrie()}')
